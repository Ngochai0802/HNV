...
function validateForm(form) {
  ...
  // 4. Ngày sinh: không phải hôm nay hoặc tương lai, tuổi < 120, và đủ 13 tuổi
  if (!form.dateOfBirth) {
    ...
    if (dob >= today) {
      ...
      if (ageYears >= 120) {
        ...
        errors.dateOfBirth = 'Người dùng phải từ đủ 13 tuổi trở lên.';
      }
    }
  }
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={inputCls('password') + ' pr-11 tracking-widest [&::-ms-reveal]:hidden [&::-ms-clear]:hidden [&::-webkit-credentials-auto-fill-button]:hidden'}
                />
                <button
                  type="button"
